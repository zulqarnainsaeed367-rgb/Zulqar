      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              // Added overflow-hidden to contain the blurred image
            ...
            >
              ...
              {/* 2. The Blurred Background Image Layer */}
              <div 
                ...
                style={{
                  ...
                  // Apply heavy blur and reduce brightness
                  filter: 'blur(20px) brightness(0.7) saturate(0.8)',
                  // Reduce opacity slightly to blend with the card background
                  opacity: '0.6'
                }}
              />

              {/* Keep the spotlight effect, but change colors slightly to blend */}
              ...
              {/* Set content to z-10 to stay above the image */}
